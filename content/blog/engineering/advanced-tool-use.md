...
`due_date` use "2024-11-06", "Nov 6, 2024", or "2024-11-06T00:00:00Z"?`reporter.id` a UUID, "USR-12345", or just "12345"?`reporter.contact`?`escalation.level` and `escalation.sla_hours` relate to priority?
