...
Claude Opus 4.6 is available today on [claude.ai](https://claude.ai/redirect/website.v1.b6949570-09c1-4439-81f3-2fddf08127c9), our API, and all major cloud platforms. If you’re a developer, use `claude-opus-4-6` via the [Claude API](https://platform.claude.com/docs/en/about-claude/models/overview). Pricing remains the same at $5/$25 per million tokens; for full details, see our [pricing page](https://claude.com/pricing#api).
