...
Earlier this month, we introduced [Agent Skills](https://www.anthropic.com/news/skills). Skills are folders that include instructions, scripts, and resources that Claude can use to perform given tasks. Skills work across all Claude apps, including [Claude.ai](http://claude.ai/redirect/website.v1.490d5ff1-2ae7-4f49-9b55-e278bd1e2d1e), Claude Code, and our API. To make Claude better at financial services tasks, we’ve added 6 new skills:
