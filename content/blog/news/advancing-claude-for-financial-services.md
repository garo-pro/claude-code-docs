...
Earlier this month, we introduced [Agent Skills](https://www.anthropic.com/news/skills). Skills are folders that include instructions, scripts, and resources that Claude can use to perform given tasks. Skills work across all Claude apps, including [Claude.ai](http://claude.ai/redirect/website.v1.e9aed5d7-f4ca-45d4-8273-babd1ec823b9), Claude Code, and our API. To make Claude better at financial services tasks, we’ve added 6 new skills:
