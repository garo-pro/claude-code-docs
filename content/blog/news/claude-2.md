...
Claude 2 powers our chat experience, and is generally available in the US and UK. We are working to make Claude more globally available in the coming months. You can now [create an account](https://claude.ai/redirect/website.v1.a0ce1784-65ca-4b9f-a21b-5713b383073e) and start talking to Claude in natural language, asking it for help with any tasks that you like. Talking to an AI assistant can take some trial and error, so [read up on our tips](https://console.anthropic.com/docs/prompt-design) to get the most out of Claude.
